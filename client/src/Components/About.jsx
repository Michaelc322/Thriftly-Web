...
const About = () => {
  return (
    <Container>
      ...
      >
        The safe and efficient way to buy and sell in college
      </HeaderText>
      ...
      <CardContainer>
        ...
        >
          ...
          <SubText>
            Verify your school email to get started. Browse listings from other
        ...
        >
          ...
          <SubText>
            Follow and connect with other students! Create a profile and stay up
            to date with listings from your friends.
          </SubText>
        </Card>
        ...
        >
          ...
          <SubText>
            Create your first listing in seconds! Let the students at your
            university make your profile a marketplace.
          </SubText>
        </Card>
      </CardContainer>
    </Container>
