...
const Home = () => {
  return (
    ...
    <Section id="home">
        <HeaderContainer>
            <HeaderInfo>
                <LogoHeader src="/logos/whiteText.png" 
                ...
                >The #1 social marketplace app for university students</HeaderSubText>
                <HeaderButtonGroup>
                    <DownloadButton href='/'>
                    <Icon className='fa-brands fa-app-store-ios'/>
                    <DownloadText>Download on the <span>App Store</span></DownloadText>
                    </DownloadButton>
            ...
            <HeaderImageGroup>
            <PhoneMock src="/screens/listings.png"
                initial={{ opacity: 0, y: 50 }}
                animate={{ opacity: 1, y: 0 }}
